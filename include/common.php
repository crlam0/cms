...
$JQUERY_INC='<script type="text/javascript" src="'.$BASE_HREF.'include/jquery.js"></script>'."\n";
$JQUERY_FORM_INC='<script type="text/javascript" src="'.$BASE_HREF.'include/jquery.form.js"></script>'."\n";

$EDITOR_INC='<script type="text/javascript" src="'.$BASE_HREF.'include/ckeditor/ckeditor.js" charset="utf-8"></script>'."\n".
'<script type="text/javascript" src="'.$BASE_HREF.'include/editor.js"></script>'."\n";

$EDITOR_MINI_INC= ' <script type="text/javascript" src="'.$BASE_HREF.'include/ckeditor/ckeditor.js" charset="utf-8"></script>'."\n".
'<script type="text/javascript" src="'.$BASE_HREF.'include/editor_mini.js"></script>'."\n";;

$EDITOR_HTML_INC='<script type="text/javascript" src="'.$BASE_HREF.'include/edit_area/edit_area_full.js" charset="utf-8">></script>'."\n".
'<script type="text/javascript" src="'.$BASE_HREF.'include/editor_html.js" charset="utf-8"></script>'."\n";;

$tags[nav_str]="<a href=$SUBDIR class=nav_home>Главная</a>";

$_SERVER["PHP_SELF_DIR"]=dirname($_SERVER["PHP_SELF"])."/";
