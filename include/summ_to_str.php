<?php
//Функция перевода цифр в сумму прописью. Подаете цифру (разделитель рублей и копеек - точка или запятая, 
//максимальная сумма - миллиард рублей), на выходе у функции - сумма прописью.
