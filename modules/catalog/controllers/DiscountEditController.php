...
class DiscountEditController extends BaseController
{
    private $table;
    ...
    {
        $query = "SELECT * from {$this->table} order by summ asc";
        $result = App::$db->query($query);

        return $this->render('discount_table.html.twig', [], $result);
    }
    ...
    public function actionCreate(): string
    {
        ...
        return $this->render('discount_form.html.twig', $tags);
    }
