...
class Filemanager {
  ...
  private function cleanString($string, $allowed = array()) {
    ...
    $mapping = array(
        'Е '=>'S', 'ЕЎ'=>'s', 'Дђ'=>'Dj', 'Д‘'=>'dj', 'ЕЅ'=>'Z', 'Еѕ'=>'z', 'ДЊ'=>'C', 'ДЌ'=>'c', 'Д†'=>'C', 'Д‡'=>'c',
        'ГЂ'=>'A', 'ГЃ'=>'A', 'Г‚'=>'A', 'Гѓ'=>'A', 'Г„'=>'A', 'Г…'=>'A', 'Г†'=>'A', 'Г‡'=>'C', 'Г€'=>'E', 'Г‰'=>'E',
        'ГЉ'=>'E', 'Г‹'=>'E', 'ГЊ'=>'I', 'ГЌ'=>'I', 'ГЋ'=>'I', 'ГЏ'=>'I', 'Г‘'=>'N', 'Г’'=>'O', 'Г“'=>'O', 'Г”'=>'O',
        'Г•'=>'O', 'Г–'=>'O', 'Еђ'=>'O', 'Г'=>'O', 'Г™'=>'U', 'Гљ'=>'U', 'Г›'=>'U', 'Гњ'=>'U', 'Е°'=>'U', 'Гќ'=>'Y',
        'Гћ'=>'B', 'Гџ'=>'Ss','Г '=>'a', 'ГЎ'=>'a', 'Гў'=>'a', 'ГЈ'=>'a', 'Г¤'=>'a', 'ГҐ'=>'a', 'Г¦'=>'a', 'Г§'=>'c',
        'ГЁ'=>'e', 'Г©'=>'e', 'ГЄ'=>'e', 'Г«'=>'e', 'Г¬'=>'i', 'Г­'=>'i', 'Г®'=>'i', 'ГЇ'=>'i', 'Г°'=>'o', 'Г±'=>'n',
        'ГІ'=>'o', 'Гі'=>'o', 'Гґ'=>'o', 'Гµ'=>'o', 'Г¶'=>'o', 'Е‘'=>'o', 'Гё'=>'o', 'Г№'=>'u', 'Гє'=>'u', 'Е±'=>'u',
        'Г»'=>'u', 'ГЅ'=>'y', 'ГЅ'=>'y', 'Гѕ'=>'b', 'Гї'=>'y', 'Е”'=>'R', 'Е•'=>'r', ' '=>'_', "'"=>'_', '/'=>''
        );
