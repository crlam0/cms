...
$EDITOR_INC='<script type="text/javascript" src="'.$SUBDIR.'vendor/ckeditor/ckeditor/ckeditor.js" charset="utf-8"></script>'."\n".
'<script type="text/javascript" src="'.$SUBDIR.'include/js/editor.js"></script>'."\n";

$EDITOR_MINI_INC= ' <script type="text/javascript" src="'.$SUBDIR.'vendor/ckeditor/ckeditor/ckeditor.js" charset="utf-8"></script>'."\n".
