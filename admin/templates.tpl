...
<table width=800 border=0 cellspacing=1 cellpadding=1 class="table table-striped table-responsive table-bordered normal-form" align=center>
...
<br><center><table width=700 border=0 cellspacing=1 cellpadding=1 class="table table-responsive table-bordered normal-form" align=center>
<tr class=header align=center>
	<td width=15%>Дата</td>
...
<input type=hidden name=id value=[%id%]>
<input type=hidden name=[%type%] value=1>
<table align=center width=500 border=0 cellspacing=1 cellpadding=1 class="table table-striped table-responsive table-bordered normal-form">
	<tr class=header><td colspan=2>[%form_title%]</td></tr>
	<tr class=content align=left><td>Название:</td><td><input class="form-control" type=edit maxlength=255 size=64 name=form[title] value="[%title%]"></td></tr>
	<tr class=content align=left><td>Алиас:</td><td><input class="form-control" type=edit maxlength=255 size=64 name=form[seo_alias] value="[%seo_alias%]"></td></tr>
...
<br>
<table width=900 border=0 cellspacing=1 cellpadding=1 class="table table-striped table-responsive table-bordered normal-form" align=center>
<tr class=header align=center>
	<td width=5%>Номер</td>
...
<table width=550 border=0 cellspacing=1 cellpadding=1 class="table table-striped table-responsive table-bordered normal-form" align=center>
...
<br>
<table width=700 border=0 cellspacing=1 cellpadding=1 class="table table-striped table-responsive table-bordered normal-form" align=center>
<tr class=header align=center>
	<td width=15%>Дата</td>
...
<table width=400 border=0 cellspacing=1 cellpadding=1 class="table table-striped table-responsive table-bordered normal-form" align=center>
<tr class=header align=center>
<td width=70%>Хост</td>
